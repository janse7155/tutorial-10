...
function calCaption(calDate) {
    ...
    var monthName = ["January", "Febuary", "March", "April", "May", "June", "July", "August", "Septemeber", "October", "November", "December"];
...
function daysInMonth(calDate) {
   ...
   //Return the number for days for the current month
...
for (var i = 0; i < weekDay; i++) {
   ...
   for (var i = 1; i <= totalDays; i++) {
      ...
      if (i === highlightDay) {
      htmlCode += "<td class='calendar_dates' id='calendar_today'>" + i + dayEvent[i] + "</td>"; } else {
